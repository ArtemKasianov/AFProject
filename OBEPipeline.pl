...
system("$strCat");
system("perl GenerateSVMFile.expression.pl results_treshold_$identTreshold/data_for_learning/ath.expression.filtered.predict $fescExpressionFile results_treshold_$identTreshold/training/expression/folds_all/fold_all.orthopairs 1 0 results_treshold_$identTreshold/training/expression/folds_all/orthoMCL.oma.intersect.positive.examples.fold_all.svm");
system("perl GenerateSVMFile.expression.pl results_treshold_$identTreshold/data_for_learning/ath.expression.filtered.predict $fescExpressionFile results_treshold_$identTreshold/training/expression/folds_all/virtual.orthogroup.fold_all.pairs.list 0 0 results_treshold_$identTreshold/training/expression/folds_all/orthoMCL.oma.intersect.negative.examples.fold_all.svm");
system("perl GenerateSVMFile.expression.pl results_treshold_$identTreshold/data_for_learning/ath.expression.filtered.predict $fescExpressionFile results_treshold_$identTreshold/data_for_learning/folds/fold_0.orthopairs 1 0 results_treshold_$identTreshold/training/expression/folds_all/orthoMCL.oma.intersect.positive.examples.fold_0.svm");
system("perl GenerateSVMFile.expression.pl results_treshold_$identTreshold/data_for_learning/ath.expression.filtered.predict $fescExpressionFile results_treshold_$identTreshold/data_for_learning/virtual_OG/virtual.orthogroup.fold_0.pairs.list 0 0 results_treshold_$identTreshold/training/expression/folds_all/orthoMCL.oma.intersect.negative.examples.fold_0.svm");
